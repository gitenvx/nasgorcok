...
interface Props { audioRef: React.RefObject<HTMLAudioElement | null>; }

// Berapa kata yang tampil sebelum dan sesudah kata aktif
const BEFORE = 3;
const AFTER  = 4;
...
export default function LyricsDisplay({ audioRef }: Props) {
  ...
  // Ambil slice: BEFORE kata sebelum + kata aktif + AFTER kata sesudah
