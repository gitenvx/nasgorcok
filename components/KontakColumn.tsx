    ...
    <div className="col-divider flex flex-col py-4 px-4 md:px-5">
      ...
      <div className="qris-box mt-auto hover-text">
        ...
        <div className="qris-frame relative max-w-40 mx-auto">
          <span style={{ position: "absolute", top: -1, right: -1, width: 14, height: 14, borderTop: "2px solid rgba(232,224,208,0.5)", borderRight: "2px solid rgba(232,224,208,0.5)" }} />
          <span style={{ position: "absolute", bottom: -1, left: -1, width: 14, height: 14, borderBottom: "2px solid rgba(232,224,208,0.5)", borderLeft: "2px solid rgba(232,224,208,0.5)" }} />
          <span style={{
            position: "absolute", top: -10, right: 2,
            fontFamily: "var(--font-mono)", fontSize: "0.6rem",
            color: "rgba(232,224,208,0.7)", background: "rgba(10,10,10,0.9)",
            padding: "1px 5px", border: "1px solid rgba(232,224,208,0.2)",
